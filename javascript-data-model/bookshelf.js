...
console.log("ISBN of Lindsay Bassett 'Introduction to JavaScript Object Notation: A To-the-Point Guide to JSON': ", bookshelf[0].isbn);
console.log('A book by Phil Sturgeon & Laura Bohill: ', bookshelf[2].title);
